...
class ScenePlotterConfig(BaseModel):
    """
    Configure and initialize ScenePlotter in the SimulationManager
    This class is used as the scene_plotter_cfg arg in the SimulationManager to be used for visualization
    """
    location: str
