...
#include "data_utils.h"      // get_default_agent_properties?

namespace invertedai {

std::vector<Region> get_regions_default(
    const std::string& location,
    std::optional<int> total_num_agents = std::nullopt,
    std::optional<std::map<AgentType,int>> agent_count_dict = std::nullopt,
