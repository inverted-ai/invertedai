...
generate_agents_for_region(
    const Region& region,
    const std::map<AgentType, 
    int>& agent_count_dict
) {
...
static void draw_traffic_lights(
    ...
    std::string>>& traffic_lights_states,
...
int main() {
    ...
    const int sim_length = 100;   // num steps for large_drive simulation
