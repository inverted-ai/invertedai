...
std::string DebugLogger::get_current_time_UTC_(){
...
void DebugLogger::append_request(const std::string &req, const std::string &mode){
...
void DebugLogger::append_response(const std::string &res, const std::string &mode){
    std::string date_time = this->get_current_time_UTC_();
...
void DebugLogger::write_scenario_log(const std::string &dir_path, const std::string &log_path = ""){
...
void DebugLogger::write_log_to_file(const std::string &dir_path, const bool &is_scenario_log = false){
    if (is_scenario_log){
