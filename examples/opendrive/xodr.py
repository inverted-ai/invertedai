...
#     plt.plot(
#         lane_section_dots_x[i], lane_section_dots_y[i], 'o', ms=4.0, color='#BB5555')

# for i in range(len(road_start_dots_x)):
#     # plot a yellow dot at start of each road
#     plt.plot(road_start_dots_x[i], road_start_dots_y[i],
#              'o', ms=5.0, color='#BBBB33')
#     # and an arrow indicating road direction
#     plt.arrow(road_start_dots_x[i], road_start_dots_y[i], arrow_dx[i],
#               arrow_dy[i], width=0.1, head_width=1.0, color='#BB5555')

# # plot road id numbers
# for i in range(len(road_id)):
#     plt.text(road_id_x[i], road_id_y[i], road_id[i],
#              size=text_size, ha='center', va='center', color='#222222')
