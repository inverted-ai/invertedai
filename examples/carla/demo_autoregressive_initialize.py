...
parser.add_argument("--fov", type=float, default=300)
...
response = iai.utils.area_initialization(
    location=args.location, agent_density=15, traffic_lights_states=None, map_center=(0, 0), width=500, height=500, stride=50, static_actors=corrected_static_actors)
